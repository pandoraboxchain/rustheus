...
mod tests {
	...
	fn test_check_transaction_signature() {
		let tx: PaymentTransaction = "".into();
	...
	fn test_check_transaction_multisig() {
		let tx: PaymentTransaction = "".into();
		let signer: TransactionInputSigner = tx.into();
		let checker = TransactionSignatureChecker {
			signer: signer,
			input_index: 0,
	...
	fn test_transaction_with_high_s_signature() {
		let tx: PaymentTransaction = "".into();
		let signer: TransactionInputSigner = tx.into();
		let checker = TransactionSignatureChecker {
			signer: signer,
			input_index: 0,
	...
	fn test_transaction_from_124276() {
		let tx: PaymentTransaction = "".into();
		let signer: TransactionInputSigner = tx.into();
		let checker = TransactionSignatureChecker {
			signer: signer,
			input_index: 0,
	...
	fn test_transaction_bip65() {
		let tx: PaymentTransaction = "".into();
		let signer: TransactionInputSigner = tx.into();
		let checker = TransactionSignatureChecker {
			signer: signer,
			input_index: 1,
	...
	fn test_arithmetic_correct_arguments_order() {
		let tx: PaymentTransaction = "".into();
		let signer: TransactionInputSigner = tx.into();
		let checker = TransactionSignatureChecker {
			signer: signer,
			input_index: 0,
	...
	fn test_transaction_find_and_delete() {
		let tx: PaymentTransaction = "".into();
		let signer: TransactionInputSigner = tx.into();
		let checker = TransactionSignatureChecker {
			signer: signer,
			input_index: 1,
	...
	fn run_witness_test_tx_test(script_pubkey: Script, tx: &PaymentTransaction, flags: &VerificationFlags, amount: u64, index: usize) -> Result<(), Error> {
		let checker = TransactionSignatureChecker {
			input_index: index,
			input_amount: amount,
