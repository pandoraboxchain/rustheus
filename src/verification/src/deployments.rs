...
use params::{ConsensusParams, Deployment};
use hash::H256;
...
impl Deployments {
	...
	pub fn csv(&self, _number: u32, _headers: &BlockHeaderProvider, _consensus: &ConsensusParams) -> bool {
		true
	}

	/// Returns true if SegWit deployment is active
	pub fn segwit(&self, _number: u32, _headers: &BlockHeaderProvider, _consensus: &ConsensusParams) -> bool {
		true
	}
}
