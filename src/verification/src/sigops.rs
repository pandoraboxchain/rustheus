...
pub fn transaction_sigops(
	...
	let mut pay_to_script_hash_sigops = 0usize;
	...
	for input in &transaction.inputs {
		...
		pay_to_script_hash_sigops += input_script.pay_to_script_hash_sigops(&prevout_script);
	}

	input_sigops + output_sigops + pay_to_script_hash_sigops	//TODO check if this is bip16 all about
}
