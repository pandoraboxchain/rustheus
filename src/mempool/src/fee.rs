...
pub fn transaction_fee(store: &TransactionProvider, transaction: &PaymentTransaction) -> u64 {
...
pub fn transaction_fee_rate(store: &TransactionProvider, transaction: &PaymentTransaction) -> u64 {
